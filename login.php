...
<body class="min-h-screen flex items-center justify-center px-6">
    ...
    <div class="w-full max-w-sm">
        ...
        <a href="index.php"
           class="font-mono-data text-xs text-muted hover:text-signal">
            &larr; BillGuard
        </a>

        <h1 class="font-serif text-3xl mt-6 mb-1">
            Welcome back
        </h1>
        ...
        <form method="post" class="space-y-4">
            ...
            <div>
                <label class="block font-mono-data text-xs text-muted mb-1">
                    Email
                </label>
            ...
            <button
                type="submit"
                class="w-full btn-signal py-2.5 text-sm mt-2">
                Log in
            </button>
        ...
        <p class="text-muted text-xs font-mono-data mt-6">
            No account yet?
            <a href="register.php" class="text-paper hover:text-signal">
                Create one
            </a>
        </p>
